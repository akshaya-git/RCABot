...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        collection_interval = int(config.collection_interval)
        print(f"Starting continuous monitoring (interval: {collection_interval}s)")
        monitoring_task = asyncio.create_task(agent.run_continuous(collection_interval))
