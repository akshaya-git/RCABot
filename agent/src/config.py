...
class Config:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "collectors": {
                "alarms": {"enabled": os.getenv("ENABLE_ALARMS_COLLECTOR", "true").lower() == "true"},
                "metrics": {"enabled": os.getenv("ENABLE_METRICS_COLLECTOR", "true").lower() == "true"},
                "logs": {"enabled": os.getenv("ENABLE_LOGS_COLLECTOR", "true").lower() == "true"},
                "insights": {"enabled": os.getenv("ENABLE_INSIGHTS_COLLECTOR", "true").lower() == "true"},
            },
            "servicenow": {
