...
read -p "RAG Confidence Threshold (0.0-1.0, 0=disabled) [0.0]: " RAG_CONFIDENCE_THRESHOLD
RAG_CONFIDENCE_THRESHOLD=${RAG_CONFIDENCE_THRESHOLD:-0.0}
...
export RAG_CONFIDENCE_THRESHOLD
